...
namespace CRMTests.TestCases
{
    public static class TestCase
    {
        ...
        {
            Model.GetModel().ExecuteActionQuery("DELETE FROM contact_persons WHERE cid = " + TestCustomer.cid);
            Model.GetModel().ExecuteActionQuery("DELETE FROM notes WHERE cid = " + TestCustomer.cid);
            Model.GetModel().ExecuteActionQuery("DELETE FROM customers WHERE cid = " + TestCustomer.cid);
        }

        public static void DeleteTestContactPerson()
        {
            Model.GetModel().ExecuteActionQuery("DELETE FROM contact_persons WHERE id = " + TestContactPerson.id);
        }

        public static void DeleteTestNote()
        {
            Model.GetModel().ExecuteActionQuery("DELETE FROM notes WHERE id = " + TestNote.id);
        }
        ...
        public static void InsertTestCustomer()
        {
            ...
            Model.GetModel().ExecuteActionQuery(sql);            
        }
